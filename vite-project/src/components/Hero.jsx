    ...
    <div className="mx-auto relative z-50 w-full max-w-7xl px-5 py-16 md:px-10 md:py-24 lg:py-32">
      ...
      <div className="grid grid-cols-1 items-center gap-8 sm:gap-20 lg:grid-cols-2">
        ...
        <div className="max-w-[720px]">
            <p className='text-[#247fff]'>Without data, you are blind and deaf in a freeway</p>
          ...
          <p className="mb-6 max-w-[528px] text-xl text-[#aeaeae] md:mb-10">
           Coming soon, we also offer Dstv, Gotv, Startimes and Electricity Subscription.
          </p>
          <div className='flex flex-row gap-4'>
          <button type="button" class="text-white bg-[#247fff] hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-8 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Sign Up</button>
          <button type="button" class="py-2.5 px-8 me-2 mb-2 text-sm font-medium text-gray-100 focus:outline-none bg-[#4c4c4c] rounded-lg border border-[#247fff] hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">Sign In</button>
